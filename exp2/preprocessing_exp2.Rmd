...
react_files = list.files(path ="data/", pattern="*_reactlog.csv", full.names = TRUE)
...
```{r}
reactdata_filt <- filter(reactdata_pad, !(sub_id %in% c(1038, 1052, 1070, 1102, 1063, 1040)))
```
...
reactdata_plus_logs <- left_join(reactdata_filt, perf, by = c("sub_id", "step_number", "thirtysec"))
