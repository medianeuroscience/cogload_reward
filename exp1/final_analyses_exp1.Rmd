...
plt1 <- ggplot(plt_data1, aes(y = meanrt, 
                     x = as.factor(cogload), 
...
ggsave("exp1_cog_rt_main.png", plot =  plt1, path = "figures/", device = png(), width = 6, height = 24, units = "cm", dpi  = 300)

plot(plt1)

# Performance

plt2 <- ggplot(plt_data1, aes(y = meanperf, 
                     x = as.factor(cogload), 
                     color = as.factor(cogload))) + 
  geom_jitter(width = 0.1, alpha = 0.5, aes(color = as.factor(cogload))) + 
  theme_few() + 
...
ggsave("exp1_cog_perf_main.png", plot =  plt2, path = "figures/", device = png(), width = 6, height = 24, units = "cm", dpi  = 300)
...
ggsave("exp1_rw_rt_main.png", plot =  plt1, path = "figures/", device = png(), width = 6, height = 24, units = "cm", dpi  = 300)
...
ggsave("exp1_rw_perf_main.png", plot =  plt2, path = "figures/", device = png(), width = 6, height = 24, units = "cm", dpi  = 300)
...
ggsave("exp1_cog_rw_rt_interacts.png", plot =  plt1, path = "figures/", device = png(), width = 10, height = 24, units = "cm", dpi  = 300)
...
ggsave("exp1_cog_rw_perf_interacts.png", plot =  plt2, path = "figures/", device = png(), width = 10, height = 24, units = "cm", dpi  = 300)
