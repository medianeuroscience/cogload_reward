...
Looks like subjects 1006, 1013, 1051, 1100, 1112, 1123, 1082, 1192, and 1194 are outliers when it comes to STRTs. Subject 1027 did not collect crystals. No performance outliers that are not already accounted for by the STRT outliers.

```{r}
reactdata_filt <- filter(reactdata_pad, !(sub_id %in% c(1006, 1013, 1027, 1051, 1100, 1112, 1123, 1082, 1192, 1194)))
```
