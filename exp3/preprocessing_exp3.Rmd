...
Looks like subjects 1013, 1021, 1029, 1061, & 1071 never responded to the STRT probes. Subjects 1012 & 1062 didn't collect hardly crystals. We will go ahead and toss them.  

```{r}
reactdata_filt <- filter(reactdata_pad, !(sub_id %in% c(1012, 1013, 1021, 1029, 1061, 1062, 1071)))
```
