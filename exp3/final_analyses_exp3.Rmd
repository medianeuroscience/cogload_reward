...
# STRT 
png(file="figures/exp3_cog_rt_main.png",width=700,height=3200, res = 300)
...
png(file="figures/exp3_cog_perf_main.png",width=700,height=3200, res = 300)
...
png(file="figures/exp3_rw_rt_main.png",width=700,height=3200, res = 300)
...
png(file="figures/exp3_rw_perf_main.png",width=700,height=3200, res = 300)
...
png(file="figures/exp3_cog_rw_rt_interact.png",width=1200,height=3200, res = 300)
...
png(file="figures/exp3_cog_rw_perf_interact.png",width=1200,height=3200, res = 300)
...
Looks like same story as above. No significant main effect of reward on primary task performance. 
...
We do get a strong interaction here. 

### Interaction between cognitive load and reward on performance

```{r}

bf <- anovaBF(perf ~ cogload*reward + sub_id + reward:sub_id + cogload:sub_id, data=data_bf, whichRandom = c("sub_id", "reward:sub_id", "cogload:sub_id"))
...
Strong interaction here as well. 