...
ggsave("exp3_cog_rt_main.png", plot =  plt1, path = "figures/", device = png(), width = 6, height = 24, units = "cm", dpi  = 300)
...
ggsave("exp3_cog_perf_main.png", plot =  plt2, path = "figures/", device = png(), width = 6, height = 24, units = "cm", dpi  = 300)
...
ggsave("exp3_rw_rt_main.png", plot =  plt1, path = "figures/", width = 6, height = 24, units = "cm", dpi  = 300)
...
ggsave("exp3_rw_perf_main.png", plot =  plt2, path = "figures/", width = 6, height = 24, units = "cm", dpi  = 300)
...
ggsave("exp3_cog_rw_rt_interact.png", plot =  plt1, path = "figures/", width = 10, height = 24, units = "cm", dpi  = 300)
...
ggsave("exp3_cog_rw_perf_interact.png", plot =  plt2, path = "figures/", width = 10, height = 24, units = "cm", dpi  = 300)
...
plt1 <- ggplot(plt_data1, aes(x = cogload, y = meanrt, color = as.factor(grp))) +
  geom_point(position = position_jitterdodge(dodge.width = 0.5, jitter.width = 0.2), alpha = 0.5) +
  scale_color_few() + 
  theme_few() + 
  facet_wrap(~ grp) + 
  geom_point(data = plt_data2, 
...
plt2 <- ggplot(plt_data1, aes(x = cogload, y = meanperf, color = as.factor(grp))) +
  geom_point(position = position_jitterdodge(dodge.width = 0.5, jitter.width = 0.2), alpha = 0.5) + 
  theme_few() + 
  scale_color_few() + 
  facet_wrap(~ grp) + 
